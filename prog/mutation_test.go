	...
	tests := [][2]string{
		// Insert calls.
		{
			...
			"1000:mmap(&(0x7f0000000000/0x1000)=nil, (0x1000), 0x3, 0x32, 0xffffffffffffffff, 0x0)\n" +
				"1000:sched_yield()\n" +
				"1000:pipe2(&(0x7f0000000000)={0x0, 0x0}, 0x0)\n",
		},
		// Remove calls and update args.
		{
			...
			"1000:sched_yield()\n" +
				"1000:read(0xffffffffffffffff, &(0x7f0000000000)=0x0, 0x1)\n" +
				"1000:sched_yield()\n",
		},
		// Mutate flags.
		{
			...
			"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x2)\n" +
				"1000:sched_yield()\n" +
				"1000:read(r0, &(0x7f0000000000)=0x0, 0x1)\n" +
				"1000:sched_yield()\n",
		},
		// Mutate user.
		{
			...
			"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x2)\n" +
				"1000:sched_yield()\n" +
				"1001:read(r0, &(0x7f0000000000)=0x0, 0x1)\n" +
				"1000:sched_yield()\n",
		},
		// Mutate data (delete byte and update size).
		{
			...
			"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x1)\n" +
				"1000:write(r0, &(0x7f0000000000)=\"112244\", 0x3)\n",
		},
		// Mutate data (insert byte and update size).
		{
			...
			"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x1)\n" +
				"1000:write(r0, &(0x7f0000000000)=\"112255\", 0x3)\n",
		},
		// Mutate data (change byte).
		{
			...
			"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x1)\n" +
				"1000:write(r0, &(0x7f0000000000)=\"1155\", 0x2)\n",
		},
		// Change filename.
		{
			...
			"1000:open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x1)\n" +
				"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653100\", 0x22c0, 0x1)\n" +
				"1000:write(r0, &(0x7f0000000000)=\"\", 0x0)\n",
		},
		// Extend an array.
		{
			"r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x1)\n" +
			...
			"1000:mmap(&(0x7f0000000000/0x1000)=nil, (0x1000), 0x3, 0x32, 0xffffffffffffffff, 0x0)\n" +
				"1000:r0 = open(&(0x7f0000001000)=\"2e2f66696c653000\", 0x22c0, 0x1)\n" +
				"1000:readv(r0, &(0x7f0000000000)=[{&(0x7f0000001000)=\"00\", 0x1}, {&(0x7f0000002000)=\"00\", 0x2}, {&(0x7f0000000000)=\"00\", 0x3}], 0x3)\n",
		},
	}
	rs, _ := initTest(t)
nextTest:
...
func TestMinimize(t *testing.T) {
	tests := []struct {
		...
		// Remove a call.
		{
			...
			"1000:mmap(&(0x7f0000000000/0x1000)=nil, (0x1000), 0x0, 0x0, 0xffffffffffffffff, 0x0)\n" +
				"1000:pipe2(&(0x7f0000000000)={0xffffffffffffffff, 0xffffffffffffffff}, 0x0)\n",
			1,
		},
		...
		// Remove a call and replace results.
		{
			...
			"1000:mmap(&(0x7f0000000000/0x1000)=nil, (0x1000), 0x0, 0x0, 0xffffffffffffffff, 0x0)\n" +
				"1000:write(0xffffffffffffffff, &(0x7f0000000000)=\"\", 0x0)\n" +
				"1000:sched_yield()\n",
			2,
		},
		// Remove a call and replace results.
		...
		// Glue several mmaps together.
		{
			...
			"1000:mmap(&(0x7f0000000000/0x7000)=nil, (0x7000), 0x0, 0x0, 0xffffffffffffffff, 0x0)\n" +
				"1000:sched_yield()\n" +
				"1000:getpid()\n",
			2,
		},
