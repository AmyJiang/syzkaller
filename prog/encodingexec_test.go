...
func TestSerializeForExec(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			[]uint64{
				callID("syz_test$int"), uint64(U1), 5, argConst, 8, 1, 0, 0, argConst, 1, 2, 0, 0, argConst, 2, 3, 0, 0, argConst, 4, 4, 0, 0, argConst, 8, 5, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$align0"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$align1"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$align2"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$align3"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				instrCopyin, dataOffset + 1, argConst, 2, 0x43, 0, 0,
				instrCopyin, dataOffset + 4, argConst, 1, 0x44, 0, 0,
				callID("syz_test$align4"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$align5"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$align6"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$union0"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$union1"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$union2"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$array0"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$array1"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$array2"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$end0"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$end1"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$bf0"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
		{
			...
			[]uint64{
				...
				callID("syz_test$bf1"), uint64(U1), 1, argConst, ptrSize, dataOffset, 0, 0,
				instrEOF,
			},
		},
	}
